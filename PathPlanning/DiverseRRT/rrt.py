...
def main(gx=6.0, gy=10.0):
    ...
    # ====Search Path with Diverse RRT====
    obstacleList = [(5, 5, 1), (3, 6, 2), (3, 8, 2), (3, 10, 2), (7, 5, 2),
                    (9, 5, 2), (8, 10, 1)]  # [x, y, radius]
    # Set Initial parameters
    diverse_rrt = DiverseRRT(
        start=[0, 0],
        goal=[gx, gy],
        rand_area=[-2, 15],
    ...
    path = diverse_rrt.planning(animation=show_animation)
